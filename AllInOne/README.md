...
To update the database use this command from the Web project folder (replace `AllInOne` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../AllInOne.Infrastructure/AllInOne.Infrastructure.csproj -s AllInOne.Web.csproj
```
